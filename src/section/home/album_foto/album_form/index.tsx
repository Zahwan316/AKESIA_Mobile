...
const AlbumFormSection = () => {
  ...
  const {screenBeforeName, janinId = null, usgId = null, usgTitleName = null} = router.params as {screenBeforeName: string, janinId: number, usgId: number};
  ...
  const handleModal = () => {
    if(isSuccess){
      if(screenBeforeName === 'AlbumFotoJanin'){
        ...
        navigator.navigate('AlbumFotoUsg', {screenBeforeName: 'AlbumFotoJanin', janinId: janinId});
      }
      else if(screenBeforeName === 'AlbumFoto'){
        navigator.navigate('AlbumFoto', {screenBeforeName: 'AlbumFotoUsg', usgId: usgId, usgTitleName: usgTitleName});
      }
    }
